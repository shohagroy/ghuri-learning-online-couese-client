...
const Footer = () => {
  return (
    <div>
      <footer className="py-6 bg-gray-100 text-gray-50">
        <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
          <div className=" justify-between items-center block md:flex">
            ...
            <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
              <a
                ...
                href="#"
                title="Instagram"
                className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-[#00CC83] text-white"
              >
                <svg
          ...
          <div className="grid justify-center pt-6 lg:justify-between text-black">
